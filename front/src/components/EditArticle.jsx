    ...
    <Jumbotron>
        ...
        <Form>
            <Form.Group controlId="exampleForm.ControlInput1">
                ...
                <Form.Label>Image</Form.Label> <Form.Control type="text" placeholder="Image url" />
                <Form.Label>Price</Form.Label> <Form.Control type="text" placeholder="Price" />
                <Form.Label>Stock</Form.Label> <Form.Control type="text" placeholder="Stock" />
                <hr></hr><hr></hr>
